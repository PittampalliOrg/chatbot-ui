...
AS $$
DECLARE
  project_url TEXT := 'https://lrqkyhiebwwwgjjwiech.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxycWt5aGllYnd3d2dqandpZWNoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyNDc5ODQxNCwiZXhwIjoyMDQwMzc0NDE0fQ.Ct4qzifVeBR65dSFKy624vP4AFNX2uqwBCRe1kL8WI0'; -- full access needed for http request to storage
