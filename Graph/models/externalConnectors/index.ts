...
// @ts-ignore
import { BinaryOperator, BinaryOperatorObject, createPublicErrorFromDiscriminatorValue, deserializeIntoEntity, serializeEntity, serializePublicError, type Entity, type PublicError } from '../index';
// @ts-ignore
...
export interface ComplianceSettings extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface RankingHint extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
