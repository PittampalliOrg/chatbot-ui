...
// @ts-ignore
import { createDriveCollectionResponseFromDiscriminatorValue, type DriveCollectionResponse } from '../../models/index';
// @ts-ignore
...
export interface DrivesRequestBuilder extends BaseRequestBuilder<DrivesRequestBuilder> {
     ...
     * @deprecated  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see {@link https://learn.microsoft.com/graph/api/drive-list?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const DrivesRequestBuilderUriTemplate = "{+baseurl}/me/drives{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
