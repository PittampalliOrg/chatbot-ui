...
// @ts-ignore
import { createMessageFromDiscriminatorValue, serializeMessage, type Message } from '../../../models/index';
// @ts-ignore
...
export interface MessageItemRequestBuilder extends BaseRequestBuilder<MessageItemRequestBuilder> {
     ...
     * @see {@link https://learn.microsoft.com/graph/api/message-delete?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @deprecated  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see {@link https://learn.microsoft.com/graph/api/message-update?view=graph-rest-beta|Find more info here}
     */
