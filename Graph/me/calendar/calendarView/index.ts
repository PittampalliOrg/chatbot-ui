...
// @ts-ignore
import { EventItemRequestBuilderRequestsMetadata, type EventItemRequestBuilder } from './item/index';
// @ts-ignore
...
export interface CalendarViewRequestBuilder extends BaseRequestBuilder<CalendarViewRequestBuilder> {
     ...
     * @deprecated  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see {@link https://learn.microsoft.com/graph/api/calendar-list-calendarview?view=graph-rest-beta|Find more info here}
     */
 ...
 */
export const CalendarViewRequestBuilderUriTemplate = "{+baseurl}/me/calendar/calendarView?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
