...
// @ts-ignore
import { createTodoTaskFromDiscriminatorValue, serializeTodoTask, type TodoTask } from '../../../../../../models/index';
// @ts-ignore
...
// @ts-ignore
import { AttachmentSessionsRequestBuilderNavigationMetadata, AttachmentSessionsRequestBuilderRequestsMetadata, type AttachmentSessionsRequestBuilder } from './attachmentSessions/index';
// @ts-ignore
import { ChecklistItemsRequestBuilderNavigationMetadata, ChecklistItemsRequestBuilderRequestsMetadata, type ChecklistItemsRequestBuilder } from './checklistItems/index';
// @ts-ignore
import { ExtensionsRequestBuilderNavigationMetadata, ExtensionsRequestBuilderRequestsMetadata, type ExtensionsRequestBuilder } from './extensions/index';
// @ts-ignore
import { LinkedResourcesRequestBuilderNavigationMetadata, LinkedResourcesRequestBuilderRequestsMetadata, type LinkedResourcesRequestBuilder } from './linkedResources/index';
// @ts-ignore
...
=======
     * @deprecated  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see {@link https://learn.microsoft.com/graph/api/todotask-delete?view=graph-rest-beta|Find more info here}
>>>>>>> mgt
     */
...
=======
     * @deprecated  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see {@link https://learn.microsoft.com/graph/api/todotask-get?view=graph-rest-beta|Find more info here}
>>>>>>> mgt
     */
...
=======
     * @deprecated  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see {@link https://learn.microsoft.com/graph/api/todotask-update?view=graph-rest-beta|Find more info here}
>>>>>>> mgt
     */
 ...
 */
export const TodoTaskItemRequestBuilderUriTemplate = "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}{?%24expand,%24select}";
/**
