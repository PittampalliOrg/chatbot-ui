...
// @ts-ignore
import { createAttachmentBaseCollectionResponseFromDiscriminatorValue, createAttachmentBaseFromDiscriminatorValue, serializeAttachmentBase, type AttachmentBase, type AttachmentBaseCollectionResponse } from '../../../../../../../models/index';
// @ts-ignore
...
// @ts-ignore
import { CreateUploadSessionRequestBuilderRequestsMetadata, type CreateUploadSessionRequestBuilder } from './createUploadSession/index';
// @ts-ignore
import { AttachmentBaseItemRequestBuilderNavigationMetadata, AttachmentBaseItemRequestBuilderRequestsMetadata, type AttachmentBaseItemRequestBuilder } from './item/index';
// @ts-ignore
 ...
 */
export const AttachmentsRequestBuilderUriTemplate = "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/attachments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}";
/**
