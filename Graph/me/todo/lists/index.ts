...
// @ts-ignore
import { createTodoTaskListCollectionResponseFromDiscriminatorValue, createTodoTaskListFromDiscriminatorValue, serializeTodoTaskList, type TodoTaskList, type TodoTaskListCollectionResponse } from '../../../models/index';
// @ts-ignore
...
// @ts-ignore
import { TodoTaskListItemRequestBuilderNavigationMetadata, TodoTaskListItemRequestBuilderRequestsMetadata, type TodoTaskListItemRequestBuilder } from './item/index';
// @ts-ignore
...
export interface ListsRequestBuilder extends BaseRequestBuilder<ListsRequestBuilder> {
     ...
     * @deprecated  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see {@link https://learn.microsoft.com/graph/api/todo-list-lists?view=graph-rest-beta|Find more info here}
     */
     ...
     * @throws {ODataError} error when the service returns a 4XX or 5XX status code
     * @deprecated  as of 2024-07/PrivatePreview:copilotExportAPI
     * @see {@link https://learn.microsoft.com/graph/api/todo-post-lists?view=graph-rest-beta|Find more info here}
     */
