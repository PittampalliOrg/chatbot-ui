...
export interface PagesRequestBuilder extends BaseRequestBuilder<PagesRequestBuilder> {
    /**
     * Gets an item from the Chatbot-UI.Beta.me.onenote.sectionGroups.item.sections.item.pages.item collection
 ...
 */
export const PagesRequestBuilderUriTemplate = "{+baseurl}/me/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/pages";
/**
