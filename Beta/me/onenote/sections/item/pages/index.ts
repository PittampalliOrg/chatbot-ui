...
export interface PagesRequestBuilder extends BaseRequestBuilder<PagesRequestBuilder> {
    /**
     * Gets an item from the Chatbot-UI.Beta.me.onenote.sections.item.pages.item collection
 ...
 */
export const PagesRequestBuilderUriTemplate = "{+baseurl}/me/onenote/sections/{onenoteSection%2Did}/pages";
/**
