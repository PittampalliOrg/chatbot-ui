...
// @ts-ignore
import { DriveItemRequestBuilderNavigationMetadata, type DriveItemRequestBuilder } from './item/index';
// @ts-ignore
...
export interface DrivesRequestBuilder extends BaseRequestBuilder<DrivesRequestBuilder> {
    /**
     * Gets an item from the Chatbot-UI.Beta.drives.item collection
