...
// @ts-ignore
import { createDeviceFromDiscriminatorValue, createServicePrincipalFromDiscriminatorValue, createUserFromDiscriminatorValue, deserializeIntoEntity, serializeDevice, serializeEntity, serializeServicePrincipal, serializeUser, type Device, type Entity, type ServicePrincipal, type User } from '../index';
// @ts-ignore
...
export interface AlertAction extends AdditionalDataHolder, Parsable {
    /**
...
export interface ApplicationSnapshot extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface Association extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface BgpConfiguration extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface BranchConnectivityConfiguration extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export function deserializeIntoNetworkAccessTraffic(networkAccessTraffic: Partial<NetworkAccessTraffic> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "device": n => { networkAccessTraffic.device = n.getObjectValue<Device>(createDeviceFromDiscriminatorValue); },
        ...
        "user": n => { networkAccessTraffic.user = n.getObjectValue<User>(createUserFromDiscriminatorValue); },
...
export interface EnrichedAuditLogsSettings extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface Headers extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface LocalConnectivityConfiguration extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface NetworkAccessTraffic extends AdditionalDataHolder, Parsable {
    /**
...
export interface PeerConnectivityConfiguration extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface PrivateAccessDetails extends AdditionalDataHolder, Parsable {
    /**
...
export interface RedundancyConfiguration extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface RelatedResource extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface RemoteNetworkConnectivityConfiguration extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface RuleDestination extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export function serializeNetworkAccessTraffic(writer: SerializationWriter, networkAccessTraffic: Partial<NetworkAccessTraffic> | undefined | null = {}) : void {
    if (networkAccessTraffic) {
        ...
        writer.writeObjectValue<Device>("device", networkAccessTraffic.device, serializeDevice);
        ...
        writer.writeObjectValue<User>("user", networkAccessTraffic.user, serializeUser);
...
export interface ThirdPartyTokenDetails extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
...
export interface TunnelConfiguration extends AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    additionalData?: Record<string, unknown>;
