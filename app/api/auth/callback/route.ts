...
import { authProvider } from "@/app/[locale]/bff/services/auth"
import { commitSession, getSession } from "@/app/[locale]/bff/services/session"
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.redirect("http://localhost:3000/bff", {
      status: 303,
      headers: {
