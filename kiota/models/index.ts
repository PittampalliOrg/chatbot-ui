 ...
 */
// @ts-ignore
export function createTodoFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoTodo;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 ...
 */
// @ts-ignore
export function deserializeIntoTodo(todo: Partial<Todo> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
 ...
 */
// @ts-ignore
export function serializeBaseDeltaFunctionResponse(writer: SerializationWriter, baseDeltaFunctionResponse: Partial<BaseDeltaFunctionResponse> | undefined | null = {}) : void {
    if (baseDeltaFunctionResponse) {
 ...
 */
// @ts-ignore
export function serializeTodo(writer: SerializationWriter, todo: Partial<Todo> | undefined | null = {}) : void {
    if (todo) {
